...
public class HashTest {
    ...
    @Test
    public void getMethodHash() {
//        String method = "transfer(address,uint256)";
//        String method = "safeTransferFrom(address,address,uint256,bytes)";
        String method = "safeTransferFrom(address,address,uint256)";
        String hash = Hash.sha3String(method);
        String methodId = hash.substring(0, 10);
        System.out.println("method:" + method + ", methodId:" + methodId);
    }
}
